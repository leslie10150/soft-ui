<template>
	<div class="inline-container">
		...
		<template v-else>
			<div class="inline-container"
					 :class="className">
				<div class="soft-input-prepend"
						 v-if="$slots.prepend">
					<slot name="prepend"></slot>
				</div>
				<div class="soft-input-outer">
					<input type="text"
								 class="soft-input"
								 :class="styleClass"
								 :disabled="disabled"
								 ...
								 v-on="MyListeners"
								 v-model="inputValue">
					<span class="soft-input-clear"
								@click="clearInput"
								v-if="showClear">
						<!-- <soft-icon name="chahao"></soft-icon> -->
					</span>
				</div>

				<div class="soft-input-append"
						 v-if="$slots.append">
